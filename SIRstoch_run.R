...
nsims <- 500
threshold <- 10 
N <- c(5) #seq(2, 800, by=20) #c(5) #variable total abundance (set number per tree)
Ntot <- c(288, 2880, 4320) #set total abundance (variable number per tree)
#Ntot <- seq(160, 1600, by=80)
#Ntot <- NA
modstr <- c("SIR", "SIRns") #***
prev <- 0.5 #start population with X seroprevalence. Do 0, 50 and 75
